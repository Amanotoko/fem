...
mshfile = 'cross_thin.msh';
Material = [77 1.7]; %t.msh
...
f = fhTN;
%f = fhTN+fqN+fGN;
[KK ff] = boundary(Node_Num, TriEleNode, TetraEleNode, NodeCor, K, f, surf1,3);
[KK ff] = boundary(Node_Num, TriEleNode, TetraEleNode, NodeCor, KK, ff, surf2,1.5);
[KK ff] = boundary(Node_Num, TriEleNode, TetraEleNode, NodeCor, KK, ff, surf3,1.5);
[KK ff] = boundary(Node_Num, TriEleNode, TetraEleNode, NodeCor, KK, ff, surf4,1.5);
...
OFilename = 'PPcross_thin.msh';
TimeStep = 0;
%PostFileO(Node_Num,mshfile,TimeStep,T,OFilename);
PostFileO(Node_Num,mshfile,TimeStep,EList(:,4),OFilename);