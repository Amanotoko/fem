...
[KK ff] = boundary(Node_Num, TriEleNode, TetraEleNode, NodeCor, KK, ff, surf2,0);
[KK ff] = boundary(Node_Num, TriEleNode, TetraEleNode, NodeCor, KK, ff, surf3,0);
